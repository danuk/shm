...
(1,'Тариф \"Почтовый\" (${QUOTA} мб)',75,0,'web_tariff_lock','[{"service_id":8}]',NULL,NULL,NULL,NULL,1,NULL,'Тарифный план включает в себя набор услуг. Все услуги, включенные в тарифный план, полностью зависят от статуса тарифа.',NULL,NULL,0),
(2,'Тариф MIN (${QUOTA} мб)',100,0,'web_tariff','[{"service_id":8},{"service_id":5},{"service_id":29}]',NULL,1,NULL,NULL,1,NULL,'Тарифный план включает в себя набор услуг. Все услуги, включенные в тарифный план, полностью зависят от статуса тарифа.',NULL,NULL,0),
(4,'Тариф MAX (${QUOTA} мб)',200,0,'web_tariff','[{"service_id":5},{"service_id":8},{"service_id":29}]',NULL,1,NULL,NULL,1,NULL,'Тарифный план включает в себя набор услуг. Все услуги, включенные в тарифный план, полностью зависят от статуса тарифа.',NULL,NULL,0),
(5,'Web хостинг (${QUOTA} мб)',0,1,'web',NULL,NULL,NULL,NULL,1,NULL,NULL,'Web хостинг - услуга, позволяющая размещать ваш WEB сайт на сервере хостинга. Вы можете размещать несколько сайтов на одной площадке.',NULL,NULL,0),
(8,'Почта (${QUOTA} мб)',0,1,'mail',NULL,NULL,NULL,NULL,1,NULL,NULL,'Почта - услуга позволяет размещать почту на сервере для своих доменов',NULL,NULL,0),
(11,'Регистрация домена в зоне .RU: ${DOMAIN}',590,12,'domain','[{"service_id":30},{"service_id":31}]',12,NULL,NULL,NULL,1,1,'Регистрация домена осуществляется регистратором доменных имен.',NULL,NULL,0),
...
(63,'Трансфер домена: ${DOMAIN}',0,12,'transfer','[{"service_id":30},{"service_id":31}]',NULL,NULL,1,NULL,1,1,'Домен зарегистрирован в системе как &quot;Трансфер&quot;. Такие домены владелец продляет самостоятельно.',NULL,NULL,0),
(110,'Тариф X-MAX (${QUOTA} мб)',300,1,'web_tariff','[{"service_id":112},{"service_id":111},{"service_id":29}]',NULL,NULL,NULL,NULL,1,NULL,'Тарифный план включает в себя набор услуг. Все услуги, включенные в тарифный план, полностью зависят от статуса тарифа.',NULL,NULL,0),
