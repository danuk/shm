...
my $start_balance = get_service('user')->get->{balance};
...
my $balance_after_create = get_service('user')->get->{balance};
...
my $balance_after_money_back =  get_service('user')->get->{balance};
